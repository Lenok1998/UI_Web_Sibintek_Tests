...
```
gradle clean my_tests  запуск всех тестов
...
- VERSION (версия браузера, по умолчанию 100.0. Реализован запуск в Firefox на версиях 98.0 и 97.0, а также Chrome 99.0 и 100.0  и Safari 16.5.2 и 16.5.1 )
